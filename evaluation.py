...
class eval:
    def __init__(self, source_file, translation_out, refference_file, model_path="Unbabel/wmt20-comet-qe-da") -> None:
        ...
        Args:
            ...
            refference_file (str): path to a flie where the paralell refference translation of the source file is written
            model_path (str, optional): the name of hte comet translation model. Defaults to "Unbabel/wmt20-comet-qe-da". others include "Unbabel/wmt22-comet-da" and "Unbabel/XCOMET-XL" though the latter does not seem to work. check https://huggingface.co/Unbabel for others.
        """
    ...
    def comet(self, data: list[dict]) -> list[float]: 
        ...
        Args:
            data list[dict]): dictionary of source, machine translation and reference (src, mt, ref respecitvely) must be in the followint format:
            [{
                "src": "10 到 15 分钟可以送到吗",
...
if __name__ =="__main__":
    ...
    ev = eval(source_file, translation_out, refference_file)
